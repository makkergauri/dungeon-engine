...
[architecture.md](docs/architecture.md) is how it fits together.
[design-decisions.md](docs/design-decisions.md) is the honest version — tradeoffs,
limitations, and the bugs I got wrong on the way.